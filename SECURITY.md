...
- **Input Sanitization**: As of v0.15.3, Neurex strictly sanitizes all URL inputs for SSRF prevention, isolates file access to mitigate path traversal, and uses positional arguments (`--`) to prevent command injection across all subprocess layers.
