...
- **MINOR**: New features (e.g., adding Hive Mind, new panels).
...
- **Automated Validation**: Every push and Pull Request triggers the **Neurex CI** workflow. This runs:
  ...
  - **Note**: PRs cannot be merged until all status checks are green.
...
- **Documentation**: All architectural changes must be reflected in the [Roadmap](./neurex_development_plan.md).
