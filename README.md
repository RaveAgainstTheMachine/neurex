<div align="center">
  ...
  <p>
    ...
    <a href="#"><img src="https://img.shields.io/badge/Version-v0.16.0-blueviolet.svg?style=for-the-badge" alt="Version"></a>
...
> [!WARNING]
> The GitHub Releases page may serve legacy binaries (e.g. `v0.5.3`) marked as "Latest" due to release tag immutability constraints. To run the current codebase (`v0.16.0`), we recommend performing the **Manual Development Install** (Option 2) or building the CLI binary directly from the `main` branch.
...
<div align="center">
  <sub>Built by the Neurex Collective. v0.16.0.</sub>
</div>
