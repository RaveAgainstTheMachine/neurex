...
@pytest.mark.asyncio
async def test_plugin_hub_marketplace_lifecycle(test_client, db_session):
    """
    ...
    # Mock httpx to simulate a successful repository validation
    class MockResponse:
        status_code = 200
    ...
    try:
        ...
        assert data["skill"]["plugin_type"] == "mcp"
        ...
        assert published_item["plugin_type"] == "mcp"
        assert published_item["is_official"] is False
    finally:
        pass
