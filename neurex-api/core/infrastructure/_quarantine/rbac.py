...
ROLE_PERMISSIONS: dict[Role, set[Permission]] = {
    ...
    Role.REMOTE_PEER: {
        Permission.READ, Permission.EXECUTE_TERMINAL # Peers can read code and run in sandbox
    },
    Role.GUEST: {
        Permission.READ
    }
...
class RBACManager:
    ...
    def has_permission(self, token_hash: str, permission: Permission, path: str | None = None) -> bool:
