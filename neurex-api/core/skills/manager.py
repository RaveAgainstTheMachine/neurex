...
class SkillManager:
    ...
    def fetch_curated_list(self) -> list[dict[str, Any]]:
        ...
        # Fallback curated skills (20 Default Skills with Secure-by-Default Policy)
        fallback = [
            # 4 Critical Skills (Enabled by Default)
            {
                "id": "fs-elite",
                "name": "Filesystem Elite",
                "category": "Core",
                "description": "High-integrity filesystem manipulation with deep file-tree understanding. (Read operations)",
            ...
            },
            {
                ...
                "name": "LSP Helper",
                "category": "Code",
                "description": "Code navigation, symbol lookup, and reference tracking using Language Server Protocol.",
                "url": "https://github.com/neurex-swarm/skill-lsp-helper",
                "author": "Neurex Authors",
                "version": "1.0.0",
                "enabled": True,
            },
            {
                ...
                "name": "AST Parser",
                "category": "Code",
                "description": "Codebase structure mapping and semantic understanding.",
                "url": "https://github.com/neurex-swarm/skill-ast-parser",
                "author": "Neurex Authors",
                "version": "1.0.0",
                "enabled": True,
            },
            {
                ...
                "name": "Memory Weaver",
                "category": "Core",
                "description": "Context and history management for continuous learning.",
                "url": "https://github.com/neurex-swarm/skill-memory-weaver",
                "author": "Neurex Authors",
                "version": "1.0.0",
                "enabled": True,
            },
            # 16 Advanced Skills (Disabled by Default - Require Opt-in)
            {
                "id": "web-search",
                "name": "Web Search",
                "category": "Web",
            ...
            },
            {
                ...
                "url": "https://github.com/neurex-swarm/skill-git-assistant",
                "author": "Neurex Authors",
                "version": "1.0.0",
                "enabled": False,
            },
            {
                ...
                "name": "API Fetcher",
                "category": "Web",
                "description": "Interact with REST/GraphQL APIs intelligently.",
                "url": "https://github.com/neurex-swarm/skill-api-fetcher",
                "author": "Neurex Authors",
                "version": "1.0.0",
                "enabled": False,
            },
            {
                "id": "hardware-benchmarker",
                "name": "Hardware Benchmarker",
                "category": "System",
                "description": "Profile and benchmark system resources.",
                "url": "https://github.com/neurex-swarm/skill-hardware-benchmarker",
                "author": "Neurex Authors",
                "version": "1.0.0",
                "enabled": False,
            },
            {
                ...
                "name": "Docker Sandbox",
                "category": "System",
                "description": "Execute commands safely within ephemeral Docker containers.",
                "url": "https://github.com/neurex-swarm/skill-docker-sandbox",
                "author": "Neurex Authors",
                "version": "1.0.0",
                "enabled": False,
            },
            {
                ...
                "url": "https://github.com/neurex-swarm/skill-security-auditor",
                "author": "Neurex Authors",
                "version": "1.0.0",
                "enabled": False,
            },
            {
                ...
                "name": "Swarm Debater",
                "category": "Mesh",
                "description": "Agent-to-agent debate resolution for complex decision making.",
                "url": "https://github.com/neurex-swarm/skill-swarm-debater",
                "author": "Neurex Authors",
                "version": "1.0.0",
                "enabled": False,
            },
            {
                "id": "cicd-auto-healer",
                "name": "CI/CD Auto-Healer",
                "category": "System",
                "description": "Automatically diagnose and attempt to fix broken CI pipelines.",
                "url": "https://github.com/neurex-swarm/skill-cicd-auto-healer",
                "author": "Neurex Authors",
                "version": "1.0.0",
                "enabled": False,
            },
            {
                "id": "pty-shell-controller",
                "name": "PTY Shell Controller",
                "category": "Core",
                "description": "Interactive shell session management.",
                "url": "https://github.com/neurex-swarm/skill-pty-shell",
                "author": "Neurex Authors",
                "version": "1.0.0",
                "enabled": False,
            },
            {
                ...
                "category": "Code",
                "description": "Deep analysis of code changes and pull requests.",
                "url": "https://github.com/neurex-swarm/skill-git-diff-analyzer",
                "author": "Neurex Authors",
                "version": "1.0.0",
                "enabled": False,
            },
            {
                ...
                "url": "https://github.com/neurex-swarm/skill-log-sentinel",
                "author": "Neurex Authors",
                "version": "1.0.0",
                "enabled": False,
            },
            {
                "id": "cognitive-profiler",
                "name": "Cognitive Profiler",
                "category": "Mesh",
                "description": "Analyze agent performance and decision trees.",
                "url": "https://github.com/neurex-swarm/skill-cognitive-profiler",
                "author": "Neurex Authors",
                "version": "1.0.0",
                "enabled": False,
            },
            {
                "id": "knowledge-importer",
                "name": "Knowledge Importer",
                "category": "Data",
                "description": "Ingest and process external documentation and datasets.",
                "url": "https://github.com/neurex-swarm/skill-knowledge-importer",
                "author": "Neurex Authors",
                "version": "1.0.0",
                "enabled": False,
            },
