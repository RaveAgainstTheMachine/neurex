...
export function SettingsPanel() {
  ...
  const [localSettings, setLocalSettings] = useState<SettingsState | null>(store.settings ? { ...store.settings, ...store.theme } as SettingsState : null);
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      if (useStore.getState().settings) {
        setLocalSettings({ ...useStore.getState().settings, ...useStore.getState().theme } as SettingsState);
      }
