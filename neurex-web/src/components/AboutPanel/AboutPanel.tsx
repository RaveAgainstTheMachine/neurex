      ...
      >
        ...
        <div className="about-header">
          <div className="about-logo">
            <img src="/icon.png" width="48" height="48" style={{ display: 'block', margin: '0 auto' }} alt="Neurex Logo" />
          </div>
          <h1>NEUREX</h1>
          <p className="about-tagline">A local-first AI engineering workspace with distributed VRAM pooling and autonomous agents.</p>
        </div>
        ...
        <div className="about-content">
          <section className="about-section">
            ...
            <p>
              ...
              It transforms your infrastructure into a distributed mesh where agents are peers, 
          ...
          <div className="about-grid">
            ...
            <div className="about-feature">
              ...
              <div>
                <h3>VRAM Pooling</h3>
                <p>Combine GPU power across your network into a unified compute pool.</p>
              </div>
            </div>
            <div className="about-feature">
          ...
          <div className="about-footer">
            <div className="about-version">
              <span>Version 0.15.1</span>
              <span className="status-dot"></span>
              <span>Stable Platform</span>
            </div>
