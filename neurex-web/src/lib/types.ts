...
export interface NeurexStore {
  ...
  conversations: { conversation_id: string; last_message: string; title?: string }[];
  setMessages: (msgs: ChatMessage[]) => void;
  addMessage: (msg: Omit<ChatMessage, "id" | "timestamp">) => void;
  appendToken: (token: string) => void;
  replaceTokens: (content: string) => void;
  setActiveConversation: (id: string) => void;
  setConversations: (convs: { conversation_id: string; last_message: string; title?: string }[]) => void;
